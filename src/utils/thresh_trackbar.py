...
class Thresh_Trackbar:
    ...
    def load_values(self) -> bool:
        ...
        if self.img_name in config and "method" in config[self.img_name]["threshold"]:
            ...
            self.__thresh_method, self.__thresh_val, self.__block_size, self.__C_val = c["method"], c["value"], c[
                "block size"], c["C"]
    ...
    def save_values(self):
        ...
        config[self.img_name] = {
            ...
            "threshold":
                {
                    "method": self.__thresh_method, "value": self.__thresh_val, "block size": self.__block_size,
                    "C": self.__C_val
                }
        }
...
if __name__ == '__main__':
    ...
    from src.utils.perspective_transform import persp_trans
